					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							...
							<div class="kt-login__signin">
								...
								<form class="kt-form" method="post" action="../php_action/seConnecter.php">
									...
									<div class="input-group">
										<input class="form-control" type="text" placeholder="login" name="login" autocomplete="off">
									</div>
									<div class="input-group">
									...
									<div class="kt-login__actions">
										<button class="btn btn-brand btn-elevate kt-login__btn-primary">Se connecter</button>
									</div>
								</form>
							</div>
							<div class="kt-login__signup">
								<div class="kt-login__head">
									<h3 class="kt-login__title">S'inscrire</h3>
									<div class="kt-login__desc">Entrez les informations du nouveau compte:</div>
								</div>
								<form class="kt-form" method="post" action="../php_action/createUtilisateur.php">
									<div class="input-group">
										<input class="form-control" type="text" placeholder="login" name="login">
									</div>
									<div class="input-group">
										<input class="form-control" type="text" placeholder="Nom complet" name="nom">
									</div>
									<div class="input-group">
										<input class="form-control" type="tel" placeholder="Numéro de téléphone" name="telephone">
									</div>
									<div class="input-group">
										<input class="form-control" type="text" required="required" placeholder="Email" name="email" autocomplete="off">
									</div>
									<div class="input-group">
										<input class="form-control" type="password" minlength="3" placeholder="Mot de passe" name="pwd1" autocomplete="new-password">
									</div>
									<div class="input-group">
										<input class="form-control" type="password" minlength="3" placeholder="Confirmez le mot de passe" name="pwd2" autocomplete="new-password">
									</div>
									<div class="input-group">
										<label for="role">Fonction</label>
										<select class="form-control" name="role" id="exampleSelect">
											<option value="employeur">employeur</option>
											<option value="demandeur">demandeur</option>
										</select>
									</div>
									<div class="kt-login__actions">
										<button class="btn btn-brand btn-elevate kt-login__btn-primary">S'inscrire</button>
										&nbsp;&nbsp;
										<button type="reset" class="btn btn-light btn-elevate kt-login__btn-secondary">Annuler</button>
										&nbsp;&nbsp;
										<button id="kt_login_forgot_cancel" class="btn btn-light btn-elevate kt-login__btn-secondary">Retour</button>
										<br>
            							<?php
							...
							<div class="kt-login__forgot">
								<div class="kt-login__head">
									...
									<div class="kt-login__desc">Entrez votre email pour réinitialiser le mot de passe:</div>
								</div>
								<form class="kt-form" action="">
									...
									<div class="kt-login__actions">
										<button class="btn btn-brand btn-elevate kt-login__btn-primary">Demande</button>&nbsp;&nbsp;
